...
@push('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Botón para agregar una nueva fila de piezas
            document.getElementById('add-pieza-btn').addEventListener('click', () => {
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-danger mt-4 remove-pieza-btn">Eliminar</button>
            </div>
        `;

                container.appendChild(row);

                // Manejar el cambio de tipo de pieza
                row.querySelector('.tipo-select').addEventListener('change', function() {
                ...
                row.querySelector('.remove-pieza-btn').addEventListener('click', () => {
                    row.remove();
                });
            });
        });
