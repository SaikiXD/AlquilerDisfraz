...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
            <form id="multiStepForm" action="{{ route('disfrazs.update', ['disfraz' => $disfraz]) }}" method="post"
                        ...
                        <div class="col-md-4">
                            ...
                            <select title="Seleccione el género" name="genero" id="genero"
                                ...
                                <option value="masculino"
                                    {{ old('genero', $disfraz->genero) == 'masculino' ? 'selected' : '' }}>
                                    Masculino
                                </option>
                ...
                <div class="form-step" id="step2">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tipo_id" id="tipo_id" class="form-control selectpicker show-tick"
                        ...
                        <div class="col-12 mt-3">
                            <div class="table-responsive">
                                <table id="tabla_detalle" class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($disfraz->piezas as $index => $pieza)
                                            <tr>
                ...
                <div class="form-step" id="step3">
                    <h3>Paso 3</h3>
                    <div class="col-md-6 mb-2">
                        <label for="img_path" class="form-label">Imagen Actual:</label>
                        @if ($disfraz->img_path && Storage::disk('public')->exists($disfraz->img_path))
                            <img src="{{ asset('storage/' . $disfraz->img_path) }}" alt="Imagen actual"
                        ...
                        <select data-size="4" title="seleccione las categorias" data-live-search="true"
                            ...
                            @foreach ($categorias as $item)
                                <option value="{{ $item->id }}"
                                    {{ in_array($item->id, old('categorias', $disfraz->categorias->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{ $item->nombre }}
                                </option>
                            @endforeach
                        </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn_agregar').on('click', function() {
                ...
                if (!tipo || !pieza || !cantidad || !color || !talla || !material) {
...
<tr>
    ...
    <td><input type="hidden" name="arrayidtipo[]" value="${$('#tipo_id').val()}">${tipo}</td>
    <td><input type="hidden" name="arrayidpieza[]" value="${$('#pieza_id').val()}">${pieza}</td>
    ...
    <td><button type="button" class="btn btn-danger btn-sm">Eliminar</button></td>
            ...
            $('#tabla_detalle').on('click', '.btn-danger', function() {
