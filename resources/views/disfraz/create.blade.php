                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="edad_minima" id="edad_minima" class="form-control"
                            value="{{ old('edad_minima') }}" min="0" max="120">
                        @error('edad_minima')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-2">
                        ...
                        <input type="number" name="edad_maxima" id="edad_maxima" class="form-control"
                            value="{{ old('edad_maxima') }}" min="0" max="120">
                        @error('edad_maxima')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 -md-2">
                        ...
                        <select data-size="4" title="selecciones las categorias" data-live-search="true" name="categorias"
                            id="categorias_id" class="form-control selectpicker show-tick" multiple>
                    ...
                    <div class="col-md-4">
                        ...
                        <select title="seleccione el genero" name="genero" id="genero"
